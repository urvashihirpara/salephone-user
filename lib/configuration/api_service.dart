  ...
  if (await checkInternet()) {
    ...
    headerParameters = {
      "X-Authentication-token":
          getLoginData() != null && getLoginData()!.data != null
              ? getLoginData()!.data!.user != null
                  ? "${getLoginData()!.data!.user!.token}"
                  : ""
              : ""
    };
      ...
      child: SizedBox(
        child: Container(
          ...
          decoration: BoxDecoration(
              borderRadius: commonRoundBorderRadius, color: Colors.black),
          child: Column(
